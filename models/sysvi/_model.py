...
class SysVI(
    UnsupervisedTrainingMixin, RNASeqMixin, VAEMixin, ArchesMixin, BaseModelClass
):
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        self._model_summary_string = (
            "SysVI - cVAE model with optional VampPrior "
            + "and latent cycle-consistency loss."
        )
        ...
        **kwargs,
        ...
        if weight_batches:
            ...
            anndata_fields.append(
                NumericalObsField(batch_weights_key, batch_weights_key)
            )
